...
public class SessionLoginController2 {

	
	@RequestMapping("loginReg2")
	String loginReg2(Person per, HttpSession session) {
	...
	@RequestMapping("loginMain2")
	String view() {
		
		return "session/loginMain2";
	}
}
